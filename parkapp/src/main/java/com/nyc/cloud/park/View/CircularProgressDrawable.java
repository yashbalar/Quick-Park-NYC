package com.nyc.cloud.park.View;
...
public class CircularProgressDrawable extends Drawable
    ...
    private void toggleAppearingMode() {
        ...
        if (mModeAppearing) {
            ...
            int[] colors=new int[]{Color.parseColor("#7C4DFF"),Color.parseColor("#FFA000"),Color.parseColor("#03A9F4"),Color.parseColor("#FF5722"),Color.parseColor("#D32F2F")};
            int rnd = new Random().nextInt(colors.length);
            mPaint.setColor(colors[rnd]);
        }
    }
